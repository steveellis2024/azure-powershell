...
namespace Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.Api20240601Preview
{
    ...
    public partial class ClusterPropertiesEncryptionCustomerManagedKeyEncryption :
        Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.Api20240601Preview.IClusterPropertiesEncryptionCustomerManagedKeyEncryption,
        Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.Api20240601Preview.IClusterPropertiesEncryptionCustomerManagedKeyEncryptionInternal
    {

        /// <summary>Backing field for <see cref="KeyEncryptionKeyIdentity" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.Api20240601Preview.IClusterPropertiesEncryptionCustomerManagedKeyEncryptionKeyIdentity _keyEncryptionKeyIdentity;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.Api20240601Preview.IClusterPropertiesEncryptionCustomerManagedKeyEncryptionKeyIdentity KeyEncryptionKeyIdentity { get => (this._keyEncryptionKeyIdentity = this._keyEncryptionKeyIdentity ?? new Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.Api20240601Preview.ClusterPropertiesEncryptionCustomerManagedKeyEncryptionKeyIdentity()); set => this._keyEncryptionKeyIdentity = value; }
...

    {
        ...
        /// All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Models.Api20240601Preview.IClusterPropertiesEncryptionCustomerManagedKeyEncryptionKeyIdentity KeyEncryptionKeyIdentity { get; set; }
        /// <summary>
        /// Only userAssignedIdentity is supported in this API version; other types may be supported in the future
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.RedisEnterpriseCache.Support.CmkIdentityType? KeyEncryptionKeyIdentityType { get; set; }
